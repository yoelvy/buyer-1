...
module.exports = hisoka = async (hisoka, m, chatUpdate, store) => {
	...
	const ftroli ={key: {fromMe: false,"participant":"0@s.whatsapp.net", "remoteJid": "6289523258649-1604595598@g.us"}, "message": {orderMessage: {itemCount: 2021,status: 200, thumbnail: fs.readFileSync('./lib/apri.jpg'), surface: 200, message: `©Created By Nover`, orderTitle: 'follow My IG mhmmd_rivaldo1', sellerJid: '0@s.whatsapp.net'}}, contextInfo: {"forwardingScore":999,"isForwarded":true},sendEphemeral: true}
...
*•LINK : https://telegra.ph/file/0a2c2fb94fb32773b6393.jpg*
...
m.reply(mess.wait)
webapi = await fetchJson(`https://x-daniapi.herokuapp.com/api/stalk/yt?username=${text}&apikey=DaniXFar`)
...
if (!text) throw 'Username Nya Mana ?'
m.reply(mess.wait)
webapi = await fetchJson(`https://x-daniapi.herokuapp.com/api/stalk/tiktok?username=${text}&apikey=DaniXFar`)
...
hisoka.sendMessage(m.chat, {image : buffer, caption : `Nieh By Aprilia\nJangan lupa ngocok`}, {quoted : fgif})
break
case 'asupan':
m.reply(mess.wait)
...
urlButton: {
displayText: 'Grup Jb',
url: 'https://chat.whatsapp.com/Lb6PQTTyCPW3rT6wM0Gjjy | https://chat.whatsapp.com/HomCFu5u1b28uhAnInaQN8 | https://chat.whatsapp.com/Bicr7ggLAdf62XrUDOiaWH | https://chat.whatsapp.com/DwfOoysMHDxHw6wKLDgE8N | https://chat.whatsapp.com/Buc3gFZk5Va7Z381gbiO8g'
}
}, {
quickReplyButton: {
displayText: 'Status Bot',
